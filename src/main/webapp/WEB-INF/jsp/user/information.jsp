			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						<figure>
							<img src="images/information.png" alt="sing up image">
						</figure>
					...
					<div class="signin-form">
						...
						<form action="/updateinfo" method="POST" class="register-form"
							id="checkout-form">
							...
							<div class="form-group">
								<label for="your_name"><i class="zmdi zmdi-home"></i></label> <input
									...
									value="${sessionScope.account.infoUser.address }" id="address"
